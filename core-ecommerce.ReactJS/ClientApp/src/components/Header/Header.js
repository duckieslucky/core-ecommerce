                            ...
                            <div className="col-lg-6 col-6">
                                <div className="language-currency-wrap">
                                    <div className="currency-wrap border-style">
                                        <a className="currency-active" href="#">$ Dollar (US)
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <ul className="sub-menu-style">
                                                    ...
                                                    <li>
                                                        <a href="login-register.html">login / register
                                                        </a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li>
                                                ...
                                                <ul className="sub-menu-style">
                                                    <li>
                                                        <a href="blog.html">blog standard
                                                        </a>
                                                    </li>
                                                    <li>
                            ...
                            <div className="col-lg-3 col-md-6 col-6">
                                <div className="header-action-wrap">
                                    ...
                                    <div className="header-action-style">
                                        <Link title="Login Register" to="/login">
