                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="200">
                            <a href="product-details.html"><img src={img.img_banner_1} alt=""/></a>
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="400">
                            <a href="product-details.html"><img src={img.img_banner_2} alt=""/></a>
                            <div className="banner-content-1">
                                <h5>new arrival</h5>
                                <h3>Hanging Chair</h3>
                                <div className="banner-btn">
                    ...
                    <div className="col-lg-4 col-md-6 col-12">
                        <div className="banner-wrap mb-30" data-aos="fade-up" data-aos-delay="600">
                            <a href="product-details.html"><img src={img.img_banner_3} alt=""/></a>
                            <div className="banner-content-1">
                                <h5>new arrival</h5>
                                <h3>Folding Chair</h3>
                                <div className="banner-btn">
