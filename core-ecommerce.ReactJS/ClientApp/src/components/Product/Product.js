        ...
        <div className="product-area pb-95">
            <div className="container">
                ...
                <div className="product-slider-active-1 swiper-container">
                        ...
                        <div className="swiper-slide">
                            <div className="product-wrap" data-aos="fade-up" data-aos-delay="1000">
                                ...
                                <div className="product-content">
                                    ...
                                    <div className="product-price">
                                        <span className="old-price">$80.50
                                        </span>
                                        <span className="new-price">$75.25
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="product-prev-1 product-nav-1" data-aos="fade-up" data-aos-delay="200">
                        <i className="fa fa-angle-left"></i>
                    </div>
                    <div className="product-next-1 product-nav-1" data-aos="fade-up" data-aos-delay="200">
